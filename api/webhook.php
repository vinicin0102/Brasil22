...
if (!$jaProcessado) {
     ...
     * Aqui entra a liberação do acesso ao app e o envio dos adicionais
     * comprados (a descrição da cobrança lista os itens). Este bloco roda
     * uma única vez por transactionId.
     */
}
